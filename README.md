...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/platform-Windows-2563eb.svg" alt="Windows" />
...
Notra 仍在持续开发中。当前主要面向 Windows 10/11 构建和测试，提供 NSIS 与 MSI 安装包。Tauri 本身支持跨平台，但 macOS 和 Linux 尚未纳入正式发布验证。
